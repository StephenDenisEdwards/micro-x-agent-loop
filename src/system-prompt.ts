export const SYSTEM_PROMPT = `You are a helpful AI assistant with access to tools. You can execute bash commands, read files, and write files to help the user with their tasks.
